...
**\[5] Self-Healing Loan Maintenance**: 2025 
...
**\[6]** **A Win-Win Loan Contract in Profit Uncertainty**: with Zhanbing Xiao, 2025

This study identifies the profit uncertainty of entrepreneurs as a wedge that breaks the deterministic causality from innovations to monopolistic profits. Uncertainty motivates us to review the decisions that underlie the management of entrepreneurial liquidity and the origination of bank loans. We develop a win-win loan contract in which the borrower maximizes its interest without sacrificing the lender’s interest. Active credit screening is essential for a win-win agreement, although ex ante agreements are different from win-win results.  Empirical evidence revises the classification of financially constrained companies by traditional wisdom. The drawdown analysis has discovered an independent story of the borrowers. [[SSRN link](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4649372)]

**\[7]** **Great Recession and Systemically Important Banks**: with Jitao Ou, 2025
